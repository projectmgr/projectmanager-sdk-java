...
public class RestRequest<@NotNull T> {
     ...
     * </p>
     *
     * @param client a {@link ProjectManager.SDK.ProjectManagerClient} object.
     ...
     *
     * @return a {@link ProjectManager.SDK.AstroResult} object.
     */
    public @NotNull AstroResult<T> Call() {
        ...
        try {
            ...
            request.addHeader("SdkVersion", "96.0.2110.0");
