...
public class ResourceSkillClient
{
     ...
     */
    public @NotNull AstroResult<ResourceSkillDto[]> retrieveResourceSkills(@Nullable Integer top, @Nullable Integer skip, @Nullable String filter, @Nullable String orderby, @Nullable String expand)
    {
