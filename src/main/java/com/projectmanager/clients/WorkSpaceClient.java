...
public class WorkSpaceClient
{
     ...
     */
    public @NotNull AstroResult<WorkSpaceDto[]> retrievethecurrentworkspace()
    {
     ...
     * @return A {@link com.projectmanager.AstroResult} containing the results
     */
    public @NotNull AstroResult<WorkSpaceDto> updatesettingsforthecurrentworkspace(@NotNull WorkspaceSettingsUpdateDto body)
    {
