...
{
    private @Nullable IEdmEntityContainerElement[] elements;
     ...
     */
    public @Nullable IEdmEntityContainerElement[] getElements() { return this.elements; }
    /**
     *
     * @param value The new value for elements
     */
    public void setElements(@Nullable IEdmEntityContainerElement[] value) { this.elements = value; }
    /**
     *
